...
int main(void)
{
    ...
    while (quit != 'q' && quit != 'Q') {
        ...
        if (income <= 250000) {
            tax = 0;                                            //No tax for 250000tk or below income
        }

        else if (income <= 650000) {
            tax = (income - 250000) * 10 / 100;                 //10% tax for next 400000tk income
        }

        else if (income <= 1150000) {
            tax = (income - 650000) * 15 / 100 + 40000;         //15% tax for next 500000tk income
        }

        else if (income <= 2150000) {
            tax = (income - 1150000) * 20 / 100 + 115000;       //20% tax for next 1000000tk income
        }
